    ...
    let Pdisplay2=(get1,cont)=>{
        ...
        let name1=document.createElement("p");
            ...
            price.innerText=`$${get1.price}`;
            price.style.fontSize="18px";
            price.style.fontWeight="bold";

            let price0=document.createElement("p");
            price0.innerText=`4 interest-free payments of $${get1.price/4} with`;
            ...
            FreeGiftPara.innerText=`Free Bb.Illuminated Blonde Tone Enhancing Leave in with any $35+ ${get1.brand} purchase`;
